...
// Thanks to Ben Lisbakken for sample code upon which I based the charToUnicode function
...
function handleKeyDown(event) {
    ...
    if (modifier !== 0) {
        modifiersPressed = modifiersPressed | modifier; // add to the bitmast "stack"
    } else {
